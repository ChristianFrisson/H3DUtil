      ...
      foreach( feature_to_look_for ${externals_to_look_for} )
        ...
        ELSEIF( ADD_EXTERNAL )
          ...
          ELSEIF( CURRENT_CHECKED_FEATURE STREQUAL "lib" )
            ...
            ELSEIF( TARGET ${feature_to_look_for} OR H3DUtil_CMAKE_INSTALL_PREFIX )
              set( dirs_to_test "" )
              IF( TARGET ${feature_to_look_for} )
                ...
                set( dirs_to_test ${h3dutil_release_filename_path} ${dirs_to_test} )
              ENDIF( TARGET ${feature_to_look_for} )
              IF( H3DUtil_CMAKE_INSTALL_PREFIX )
                set( dirs_to_test ${dirs_to_test}
                                  ${H3DUtil_CMAKE_INSTALL_PREFIX}/${H3DUtil_lib}
                                  ${H3DUtil_CMAKE_INSTALL_PREFIX}/lib )
              ENDIF( H3DUtil_CMAKE_INSTALL_PREFIX )
              IF( dirs_to_test )
